...
export const SaveIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M5 21q-.825 0-1.413-.587T3 19V5q0-.825.587-1.413T5 3h10l6 6v10q0 .825-.587 1.413T19 21H5Zm7-10q.425 0 .713-.288T13 10V6q0-.425-.288-.713T12 5q-.425 0-.713.287T11 6v4q0 .425.287.712T12 11Zm-5 6h10V9H7v8Zm0 0V9v8Z" />
    </svg>
);

export const TrashIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M7 21q-.825 0-1.413-.587T5 19V6H4V4h5V3h6v1h5v2h-1v13q0 .825-.587 1.413T17 21H7ZM17 6H7v13h10V6ZM9 17h2V8H9v9Zm4 0h2V8h-2v9ZM7 6v13V6Z" />
  </svg>
);